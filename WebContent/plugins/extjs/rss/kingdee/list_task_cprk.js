 ...
 * 产品入库待审列表
 */
CprkTaskListPanel = Ext.extend(Ext.Panel, {
    layout: 'border',
    border: false,
  	autoScroll:true,
    initComponent: function() {
		...
		this.store = new Ext.data.JsonStore({
			url:'kingdee.do?cmd=list_task_cprk',
			root: 'result',
			totalProperty:"rowCount",
			fields:['FStatus','FInterID','FBillNo','FCancellation','FSourceBillNo','FDate','cpdm','cpmc','cpgg','jldw','fssl','wlph'],
	  		remoteSort:true,
                    	...
                    	colModel: new Ext.ux.grid.LockingColumnModel([
	                        new Ext.grid.RowNumberer(),
                            {
                                ...
                                renderer:function(value,metadata,record){
	                        		var grid = Ext.getCmp('list_task_cprk_grid');
	                        		var s = grid.getStore();
        ...
        CprkTaskListPanel.superclass.initComponent.call(this);
    }
});
