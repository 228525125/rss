 ...
 * 销售发票汇总统计
 */
XsfphztjReportPanel = Ext.extend(Ext.Panel, {
    layout: 'border',
    border: false,
    closable: true,
  	autoScroll:true,
    initComponent: function() {	
		...
		this.store = new Ext.data.JsonStore({
			url:'kingdee.do?cmd=report_xsfphztj',
			root: 'result',
			...
			fields:['wldw','cpdm','cpmc','cpgg','cpth','jldw','fssl','wsdj','hsdj','xxs','hsje'],
	  		...
	  		listeners:{
        		'beforeload': function(t,options){
		  			var grid = Ext.getCmp('report_xsfphztj_grid');
        ...
        XsfphztjReportPanel.superclass.initComponent.call(this);
    }
});
